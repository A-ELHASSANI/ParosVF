...
public class Paros {
    ...
    private static final Logger log = LoggerFactory.getLogger(Paros.class);

    private final Environment env;

    public Paros(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipsterTestMono.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Paros.class);
